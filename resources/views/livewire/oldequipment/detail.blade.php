        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Information Document Equipment Licenses</h5>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" wire:model='reminderCheckingDate' class="form-control"
                                            {{ $statusDetail == 'close' ? 'readonly' : '' }} readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" wire:model='reminderTestingDate' class="form-control"
                                            {{ $statusDetail == 'close' ? 'readonly' : '' }}>
                                    </div>
                                </div>
                                <div class="col-md-4">
